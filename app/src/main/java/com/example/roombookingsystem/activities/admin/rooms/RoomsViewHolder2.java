...
public class RoomsViewHolder2 extends RecyclerView.ViewHolder {
    ...
    public RoomsViewHolder2(@NonNull View itemView, final RoomsAdapter2.OnItemClickListener listener) {
        super(itemView);
