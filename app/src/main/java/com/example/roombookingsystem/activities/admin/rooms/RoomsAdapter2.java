...
public class RoomsAdapter2 extends  RecyclerView.Adapter<RoomsViewHolder2>{
    ...
    public RoomsAdapter2(List<Rooms> roomList, Context context) {
        RoomList = roomList;
    ...
    public RoomsViewHolder2 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View roomLayoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_available_rooms, null, false);
        ...
        return new RoomsViewHolder2(roomLayoutView, mListener);
    }

    @Override
    public void onBindViewHolder(@NonNull final RoomsViewHolder2 holder, final int position) {
